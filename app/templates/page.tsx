      ...
      <main className="py-16 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex justify-center mb-14">
            <div className="inline-flex items-center gap-3 px-5 py-3 bg-green-50 dark:bg-green-500/10 border border-green-200 dark:border-green-500/20 rounded-xl">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {templates.map((template) => (
              <div key={template.id} className="group rounded-2xl overflow-hidden border border-gray-200 dark:border-zinc-800/50 hover:border-violet-300 dark:hover:border-violet-500/30 hover:shadow-xl hover:shadow-violet-500/10 transition-all duration-500 bg-white dark:bg-zinc-900/30">
                ...
                <div className="p-5">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className="text-[10px] font-semibold tracking-wider uppercase px-2.5 py-1 rounded-full bg-green-50 dark:bg-green-500/20 text-green-700 dark:text-green-400 border border-green-200 dark:border-green-500/30">
                      {template.ats}/100
                    </span>
                  </div>
                  ...
                  <div className="flex flex-wrap gap-2 mb-5">
                    {template.features.map((feature, i) => (
                      <span key={i} className="px-2 py-0.5 text-xs bg-gray-100 dark:bg-white/5 text-gray-600 dark:text-zinc-400 rounded-md font-medium border border-gray-200 dark:border-zinc-800/50">
                        {feature}
                      </span>
                    ))}
                  </div>
          ...
          <div className="mt-14 text-center">
            <div className="inline-flex items-center gap-2 px-5 py-2.5 bg-violet-50 dark:bg-violet-500/10 rounded-full border border-violet-200 dark:border-violet-500/20">
